...
import { Terminal, BookOpen, Briefcase, MessageSquare, Menu, X, Cpu, FileText, FileCode, Layers, Zap, TrendingUp, Award, UserCircle } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-slate-950 flex font-sans text-slate-200 overflow-hidden">
      ...
      >
        ...
        {/* User Stats Module */}
        <div 
            className="p-4 border-t border-slate-800 bg-slate-950/30 cursor-pointer hover:bg-slate-900 transition-colors"
